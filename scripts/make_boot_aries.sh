...
INITRAMFS_SOURCE=micore_tools/aries/initramfs
...
MICORE_MODULES=$INITRAMFS_TMP/res/modules
...
# add updater-script
cat > micore_tools/aries/zip_template/META-INF/com/google/android/updater-script << EOF
...
# make zip archive
rm -f micore_tools/aries/zip_template/kernel.zip
